...
public class MarkerTokens extends AbstractTokenMaker {
	...
	public TokenMap getWordsToHighlight() {
		...
		tokenMap.put("constante", Token.RESERVED_WORD);
		tokenMap.put("retorno", Token.RESERVED_WORD);
		tokenMap.put("sair", Token.RESERVED_WORD);
		tokenMap.put("principal", Token.RESERVED_WORD);
		tokenMap.put("se", Token.RESERVED_WORD);
		tokenMap.put("entao", Token.RESERVED_WORD);
		tokenMap.put("senao", Token.RESERVED_WORD);
		tokenMap.put("faca", Token.RESERVED_WORD);
		tokenMap.put("ate", Token.RESERVED_WORD);
		tokenMap.put("enquanto", Token.RESERVED_WORD);
		tokenMap.put("para", Token.RESERVED_WORD);
		tokenMap.put("de", Token.RESERVED_WORD);
		tokenMap.put("ate", Token.RESERVED_WORD);
		tokenMap.put("passo", Token.RESERVED_WORD);
		tokenMap.put("ler", Token.RESERVED_WORD);
		tokenMap.put("escrever", Token.RESERVED_WORD);
